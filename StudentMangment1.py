...
class Student:
    ...
    def __init__(self, root):
        ...
        title = Label(self.root, text="Student Manegment System", font=("times new roman", "40", "bold"),
                      bg="yellow", fg="red", bd=10, relief=SUNKEN)
        ...
        T_fram = Frame(Detail_frame, bd=4, relief=RIDGE, bg="crimson")
